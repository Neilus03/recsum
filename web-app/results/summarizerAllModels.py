...
def get_model_response(text,model, keywords=None, schematic=False):
...
def summarize_text(text,model, keywords=None, schematic=False):
    """Summarizes the text based on the provided keywords using the Groq API."""
    return get_model_response(text,model, keywords, schematic)
